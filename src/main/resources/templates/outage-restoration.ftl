...
<head>
    ...
    <title>${outageType} Service Restored</title>
    <style>
        /* Base styles */
        body {
...
<div class="container">
    <div class="header">
        <h1>${outageType} Service Restored</h1>
    </div>

    <div class="content">
        <p>Hello ${username},</p>

        <p>We're pleased to inform you that the ${outageType} service in your area <strong>${areaName}</strong> has been restored.</p>

        <div class="outage-card">
            <svg xmlns="http://www.w3.org/2000/svg" class="alert-icon" fill="none" viewBox="0 0 24 24" stroke="#10B981">
            ...
            <p class="outage-value">
                <span class="status-badge">RESTORED</span>
            </p>

            <p class="outage-label">Restored Time:</p>
            <p class="outage-value">${updatedAt}</p>

            <#if actualEndTime??>
                <p class="outage-label">Actual End Time:</p>
                <p class="outage-value">${actualEndTime}</p>
            </#if>
        </div>

        <p>All services should now be operating normally. Thank you for your patience during the outage.</p>

        <p>If you're still experiencing issues with your service, please contact our support team.</p>
